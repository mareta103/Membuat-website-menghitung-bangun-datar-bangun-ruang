        ...
        if(isset($_POST['hitung'])){
            ...
            if (empty($_POST["nama"])){
                ...
                if (!preg_match("/^[a-zA-Z-' ]*$/",$nama)) {
                    $namaErr = "Hanya boleh huruf dan spasi ae";
                }
            }
            ...
            if (empty($_POST["nim"])){
                ...
                $nim = $_POST["nim"];
                if (!is_numeric($nim)) {
                    $nimErr = "Hanya boleh diisi angka ae";
                } elseif (strlen($nim) != 8){
