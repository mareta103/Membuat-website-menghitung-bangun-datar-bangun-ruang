...
<head>
    ...
    <style type="text/css">
    body {
    background: url(roket.jpg) no-repeat fixed;
...
<div class="dropdown">
  <button class="dropbtn">Bangun Datar</button>
        <div class="dropdown-content">
                    <li><a href="lingkaran.php">Lingkaran</a></li>
					<li><a href="persegi.php">Persegi</a></li>
					<li><a href="segitiga.php">Segitiga</a></li>
					<li><a href="jargen.php">Jajar Genjang</a></li>
                    <li><a href="layang.php">Layang-Layang</a></li>
  </div>
</div>
    <style>
